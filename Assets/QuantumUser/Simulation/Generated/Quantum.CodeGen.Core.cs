...
namespace Quantum {
  ...
  public unsafe partial struct Bobomb : Quantum.IComponent {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + StartLit.GetHashCode();
        hash = hash * 31 + IsLitFromStart.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        QBoolean.Serialize(&p->IsLitFromStart, serializer);
        QBoolean.Serialize(&p->StartLit, serializer);
  ...
  public unsafe partial struct CoinItem : Quantum.IComponent {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + Lifetime.GetHashCode();
        hash = hash * 31 + FeatherFall.GetHashCode();
        hash = hash * 31 + Incr.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        serializer.Stream.Serialize(&p->Incr);
        serializer.Stream.Serialize(&p->Lifetime);
        QBoolean.Serialize(&p->BlockSpawn, serializer);
        QBoolean.Serialize(&p->FeatherFall, serializer);
  ...
  public unsafe partial struct MarioPlayer : Quantum.IComponent {
    ...
    [FieldOffset(1)]
    [ExcludeFromPrototype()]
    public Byte CapeSpinFrames;
    [FieldOffset(76)]
    [ExcludeFromPrototype()]
    public QBoolean CapeJustSpun;
    [FieldOffset(232)]
    [ExcludeFromPrototype()]
    ...
    [FieldOffset(17)]
    [ExcludeFromPrototype()]
    public Byte LightningTimer;
    [FieldOffset(172)]
    [ExcludeFromPrototype()]
    public QBoolean PlayLightningCharge;
    [FieldOffset(224)]
    [ExcludeFromPrototype()]
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + HadLives.GetHashCode();
        hash = hash * 31 + FacingRight.GetHashCode();
        ...
        hash = hash * 31 + ColdBrewFrames.GetHashCode();
        ...
        hash = hash * 31 + CapeSpinFrames.GetHashCode();
        hash = hash * 31 + CapeJustSpun.GetHashCode();
        ...
        hash = hash * 31 + LightningTimer.GetHashCode();
        hash = hash * 31 + PlayLightningCharge.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        serializer.Stream.Serialize(&p->CapeSpinFrames);
        ...
        serializer.Stream.Serialize(&p->LightningTimer);
        serializer.Stream.Serialize(&p->Lives);
        ...
        serializer.Stream.Serialize(&p->ColdBrewFrames);
        ...
        QBoolean.Serialize(&p->PlayLightningCharge, serializer);
  ...
  public unsafe partial struct Projectile : Quantum.IComponent {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + JustHitGround.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        QBoolean.Serialize(&p->JustHitGround, serializer);
  ...
  public unsafe partial interface ISignalOnMarioPlayerColdBrewHit : ISignal {
    void OnMarioPlayerColdBrewHit(Frame f, EntityRef entity);
  }
  ...
  public unsafe partial class Frame {
    ...
    private ISignalOnMarioPlayerColdBrewHit[] _ISignalOnMarioPlayerColdBrewHitSystems;
    ...
    partial void InitGen() {
      ...
      _ISignalOnMarioPlayerColdBrewHitSystems = BuildSignalsArray<ISignalOnMarioPlayerColdBrewHit>();
    ...
    public unsafe partial struct FrameSignals {
      ...
      public void OnMarioPlayerColdBrewHit(EntityRef entity) {
        var array = _f._ISignalOnMarioPlayerColdBrewHitSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnMarioPlayerColdBrewHit(_f, entity);
          }
        }
      }
